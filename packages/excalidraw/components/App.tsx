...
import type { Mutable, ValueOf } from "@albertBuenaventura/common/utility-types";
...
class App extends React.Component<AppProps, AppState> {
  ...
  public updateScene = withBatchedUpdates(
    <K extends keyof AppState>(sceneData: {
       ...
       *
       * Check [API docs](https://docs.excalidraw.com/docs/@albertBuenaventura/excalidraw/api/props/excalidraw-api#captureUpdate) for more details.
       *
