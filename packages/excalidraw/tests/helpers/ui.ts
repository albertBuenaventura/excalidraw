import { pointFrom, pointRotateRads } from "@albertBuenaventura/math";
...
import { cropElement } from "@albertBuenaventura/element";
import {
  getTransformHandles,
...
import { KEYS, arrayToMap, getLineHeight } from "@albertBuenaventura/common";

import type { GlobalPoint, LocalPoint, Radians } from "@albertBuenaventura/math";

import type { TransformHandleType } from "@albertBuenaventura/element";
import type {
  ExcalidrawElement,
