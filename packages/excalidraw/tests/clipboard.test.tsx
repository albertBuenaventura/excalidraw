...
import { getElementBounds } from "@albertBuenaventura/element";
...
vi.mock("@albertBuenaventura/common", async (importOriginal) => {
  const module = await importOriginal<typeof import("@albertBuenaventura/common")>();
