...
import * as mockedSceneExportUtils from "@albertBuenaventura/excalidraw/scene/export";
import { diagramFactory } from "@albertBuenaventura/excalidraw/tests/fixtures/diagramFixture";
