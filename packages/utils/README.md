# @albertBuenaventura/utils

## Install

```bash
npm install @albertBuenaventura/utils
```

If you prefer Yarn over npm, use this command to install the Excalidraw utils package:

```bash
yarn add @albertBuenaventura/utils
```
...
```js
import { exportToSvg, exportToBlob } from "@albertBuenaventura/utils";
```

To use it in a browser directly:

```html
<script src="https://unpkg.com/@albertBuenaventura/utils@0.1.0/dist/excalidraw-utils.min.js"></script>
<script>
